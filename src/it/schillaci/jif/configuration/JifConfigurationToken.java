...
public class JifConfigurationToken {
...
// Class constructors
   ...
   /**
    * Creates a new JifConfiguration token object identifying a lexical token
    * within the JifConfiguration file.
    *
    * @param id
    ...
    */
   public JifConfigurationToken(Lexeme id, int startPos, int endPos, String content) {
    ...
    *           Configuration file.
    */
   public JifConfigurationToken(Lexeme id, int startPos, int endPos) {
