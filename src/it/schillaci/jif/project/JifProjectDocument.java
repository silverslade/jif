...
public class JifProjectDocument extends JifDocument {
    ...
    /**
     * Constructs a JifProject document with a shared set of styles for syntax
     * highlighting.
     * 
     * @param c
     ...
     *            shared across documents
     */
    public JifProjectDocument(Content c, InformContext styles) {
     ...
     *            The set of styles for Inform syntax highlighting
     */
    public JifProjectDocument(InformContext styles) {
