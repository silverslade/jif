...
public class ResourceDocument extends JifDocument {
    ...
    /**
     * Constructs a Resource document with a shared set of styles for syntax
     * highlighting.
     * 
     * @param c
     ...
     */
    protected  ResourceDocument(Content c, StyleContext styles) {
        super(c, styles);
     ...
     *            shared across documents
     */
    public ResourceDocument(Content c, InformContext styles) {
     ...
     *            The set of styles for Inform syntax highlighting
     */
    public ResourceDocument(InformContext styles) {
